...
impl<P, T> Lis2duxs12<i2c::I2cBus<P>, T, MainBank>
where
    P: I2c,
    T: DelayNs,
{
...
impl<P, T> Lis2duxs12<spi::SpiBus<P>, T, MainBank>
where
    P: SpiDevice,
    T: DelayNs,
{
...
#[bisync]
impl<B, T, S> MemBankFunctions<MemBank> for Lis2duxs12<B, T, S>
where
    B: BusOperation,
    T: DelayNs,
    S: BankState,
...
#[bisync]
impl<B, T> EmbAdvFunctions for Lis2duxs12<B, T, MainBank>
where
    B: BusOperation,
    T: DelayNs,
{
...
#[bisync]
impl<B: BusOperation, T: DelayNs, S: BankState> SensorOperation for Lis2duxs12<B, T, S> {
    type Error = Error<B::Error>;
