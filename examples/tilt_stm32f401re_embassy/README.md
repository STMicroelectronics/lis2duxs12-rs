# LIS2DUXS12 Tilt Detection on STM32F401RE Nucleo-64 Using Embassy Framework

This example demonstrates how to detect tilt events using the **LIS2DUXS12** accelerometer sensor on an **STM32F401RE** microcontroller board. The sensor is configured to generate interrupts on tilt detection, and the program outputs tilt event notifications over UART.
...
- **Sensor:** LIS2DUXS12 Accelerometer with embedded tilt detection
...
The LIS2DUXS12 sensor is connected via I2C1 on PB8/PB9. The tilt event interrupt line is connected to PB0, configured to trigger an external interrupt on rising edge. UART output is routed through PA2.
...
*This README explains the embedded Rust program for tilt detection on the LIS2DUXS12 sensor using STM32F401RE and the Embassy framework.*
